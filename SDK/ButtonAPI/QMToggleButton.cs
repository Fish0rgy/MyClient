...
namespace MyClient.SDK.ButtonAPI
{
    public class QMToggleButton
    {
        ...
        public QMToggleButton(Transform parent, string text, string toolTip, Action<bool> action)
        {
            ...
            singleButton.transform.Find("Icon_On").GetComponent<Image>().sprite = SDK.ButtonAPI.QMButtonIcons.CreateSpriteFromBase64(ButtonIcons.ToggleOn);
            singleButton.transform.Find("Icon_Off").GetComponent<Image>().sprite = SDK.ButtonAPI.QMButtonIcons.CreateSpriteFromBase64(ButtonIcons.ToggleOff);
